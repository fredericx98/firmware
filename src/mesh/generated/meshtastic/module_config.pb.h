...
typedef struct _meshtastic_ModuleConfig_RemoteSwitchConfig_Rule {
    /* Source node ID to listen for. 0 = any node */
    uint32_t source_node;
    /* GPIO pin to control */
    uint32_t pin;
    /* Seconds to keep pin HIGH after receiving a message. 0 = toggle */
    uint32_t timeout_secs;
    /* Optional substring to match in payload. Empty = any message */
    char trigger_text[32];
    /* Whether this rule is active */
    bool enabled;
} meshtastic_ModuleConfig_RemoteSwitchConfig_Rule;

/* Remote Switch Receiver Module
 Listens for DETECTION_SENSOR_APP messages and controls up to 4 GPIO outputs. */
typedef struct _meshtastic_ModuleConfig_RemoteSwitchConfig {
    /* Whether the module is enabled */
    bool enabled;
    bool has_rule1;
    meshtastic_ModuleConfig_RemoteSwitchConfig_Rule rule1;
    bool has_rule2;
    meshtastic_ModuleConfig_RemoteSwitchConfig_Rule rule2;
    bool has_rule3;
    meshtastic_ModuleConfig_RemoteSwitchConfig_Rule rule3;
    bool has_rule4;
    meshtastic_ModuleConfig_RemoteSwitchConfig_Rule rule4;
} meshtastic_ModuleConfig_RemoteSwitchConfig;
...
typedef struct _meshtastic_ModuleConfig {
    ...
    union {
        ...
        /* Remote Switch Receiver Module configuration */
        meshtastic_ModuleConfig_RemoteSwitchConfig remote_switch;
    } payload_variant;
...
#define meshtastic_ModuleConfig_RemoteSwitchConfig_init_default {0, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_default, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_default, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_default, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_default}
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_default {0, 0, 0, "", 0}
...
#define meshtastic_ModuleConfig_RemoteSwitchConfig_init_zero {0, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_zero, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_zero, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_zero, false, meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_zero}
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_init_zero {0, 0, 0, "", 0}
...
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_source_node_tag 1
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_pin_tag 2
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_timeout_secs_tag 3
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_trigger_text_tag 4
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_enabled_tag 5
#define meshtastic_ModuleConfig_RemoteSwitchConfig_enabled_tag 1
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule1_tag 2
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule2_tag 3
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule3_tag 4
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule4_tag 5
...
#define meshtastic_ModuleConfig_remote_switch_tag 17
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload_variant,remote_switch,payload_variant.remote_switch),  17)
...
#define meshtastic_ModuleConfig_payload_variant_remote_switch_MSGTYPE meshtastic_ModuleConfig_RemoteSwitchConfig
...
#define meshtastic_ModuleConfig_RemoteSwitchConfig_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     enabled,           1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rule1,             2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rule2,             3) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rule3,             4) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rule4,             5)
#define meshtastic_ModuleConfig_RemoteSwitchConfig_CALLBACK NULL
#define meshtastic_ModuleConfig_RemoteSwitchConfig_DEFAULT NULL
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule1_MSGTYPE meshtastic_ModuleConfig_RemoteSwitchConfig_Rule
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule2_MSGTYPE meshtastic_ModuleConfig_RemoteSwitchConfig_Rule
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule3_MSGTYPE meshtastic_ModuleConfig_RemoteSwitchConfig_Rule
#define meshtastic_ModuleConfig_RemoteSwitchConfig_rule4_MSGTYPE meshtastic_ModuleConfig_RemoteSwitchConfig_Rule

#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   source_node,       1) \
X(a, STATIC,   SINGULAR, UINT32,   pin,               2) \
X(a, STATIC,   SINGULAR, UINT32,   timeout_secs,      3) \
X(a, STATIC,   SINGULAR, STRING,   trigger_text,      4) \
X(a, STATIC,   SINGULAR, BOOL,     enabled,           5)
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_CALLBACK NULL
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_DEFAULT NULL
...
extern const pb_msgdesc_t meshtastic_ModuleConfig_RemoteSwitchConfig_msg;
extern const pb_msgdesc_t meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_msg;
...
#define meshtastic_ModuleConfig_RemoteSwitchConfig_fields &meshtastic_ModuleConfig_RemoteSwitchConfig_msg
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_fields &meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_msg
...
#define meshtastic_ModuleConfig_RemoteSwitchConfig_Rule_size 53
#define meshtastic_ModuleConfig_RemoteSwitchConfig_size 222
